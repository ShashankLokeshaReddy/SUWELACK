...
"""
def endta51cancelt905(apersnr,asa):
...
def fabuchta55():
	...
	if xbuchen == True:
		...
		kt002.BuchTA55_3(xClDetails, xFAStatus, xFATS, xFAEndeTS, kt002.T905_NrSelected, kt002.dr_T910("T910_Nr"), xFAMeGut, xMengeAus, kt002.dr_TA06Buch("TA06_TE"), xtrman, xta11nr, xcharge, xVal1, xVal2, xVal3, xVal4, xVal5, xScanFA)
		...
		if xInputMengeNew == 1:
			...
			if xbuchen == True:
				...
				kt002.BuchTA55_3(xClDetails, xFANewStatus, xFATS, xFAEndeTS, T905_NrSelected, 0, xFANewMe, xMengeAus, kt002.dr_TA06Buch("TA06_TE"), xtrman, xta11nr, xcharge, xVal1, xVal2, xVal3, xVal4, xVal5, xScanFA)
	...
	if xbCancel == False:
		...
		if kt002.gtv("TA22_Typ")  == "7":
			...
			if xDialog == True:
				...
				kt002.BuchTA51_3(xClDetails, xTSEnd, kt002.gtv("T910_Nr"), kt002.gtv("TA06_FA_Nr"), kt002.gtv("TA06_BelegNr"), xStatusMenge, kt002.gtv("T910_Entlohnung")
...
def actbuchung(ta29nr,AKst,ASA,t905nr,ASALast,AKstLast,ATSLast,APlatz):
  ...
  #ByRef ASALast As String, ByRef AKstLast As String, ByRef ATSLast As String, ByRef AT905Last As String, ByRef ATA29Last As String) as string
	...
	xret = endta51cancelt905(xpersnr,ASA)
