...
print(f"[DLL] Pruef_PNR checkfa: {checkfa}, nr: {nr}, sa: {sa}, bufunktion: {bufunktion}")
...
if ret == True:
		...
		print(str(bufunktion) + ":"+  str(scantype) +":"+   str(sa) + ":"+  str(buaction) +":"+   str(appmscreen2) +":"+   str(scanon) +":"+   str(activefkt) +":"+   str(msg)) 
