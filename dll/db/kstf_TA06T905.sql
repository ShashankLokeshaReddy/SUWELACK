...
/****** Object:  UserDefinedFunction [dbo].[kstf_TA06T905]    Script Date: 06.04.2022 11:10:56 ******/
DROP FUNCTION [dbo].[kstf_TA06T905]
GO
...
-- Description:    TA06 FA/Platz liefern mit FA like
-- ==========================================================================================
CREATE FUNCTION [dbo].[kstf_TA06T905]
(    
...
(
    ...
    -- ,TA20_Nr,TA20_Bez
        ...
        inner join KSAlias.dbo.TA06_FAD3 as b on a.TA06_FirmaNR  =@FirmaNr and b.TA06_FirmaNr =a.TA06_FirmaNr and b.TA06_BelegNr = a.TA06_BelegNr and  TA06_Platz_Soll = @Platz  and  TA06_FA_NR like @FANr
