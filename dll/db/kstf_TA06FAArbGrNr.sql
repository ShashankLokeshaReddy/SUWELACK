...
/****** Object:  UserDefinedFunction [dbo].[kstf_TA06FAArbGrNr]    Script Date: 06.04.2022 11:11:44 ******/
SET ANSI_NULLS ON
GO
...
-- Description:    TA06 FA/Platz über Platzgruppe liefern (Aufruf vom Terminal)
-- ==========================================================================================
CREATE OR ALTER FUNCTION [dbo].[kstf_TA06FAArbGrNr]
(    
...
(
    ...
    --     inner join KSAlias.dbo.ta05_fak1 on ta05_firmanr = a.ta06_firmanr and ta05_fa_nr = a.ta06_fa_nr
        inner join KSAlias.dbo.t905_ArbMasch on t905_firmanr = a.ta06_firmanr and T905_ArbGrNr = a.TA06_Platz_Soll
