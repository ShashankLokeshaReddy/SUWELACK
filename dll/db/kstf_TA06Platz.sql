...
/****** Object:  UserDefinedFunction [dbo].[kstf_TA06Platz]    Script Date: 06.04.2022 11:10:34 ******/
DROP FUNCTION [dbo].[kstf_TA06Platz]
GO
...
-- Description:    TA06 Belegnummer/Platz neues Terminal
-- nicht mit Platz Soll gejointet, sondern mit Arbeitsplatz
-- ==========================================================================================
Create FUNCTION [dbo].[kstf_TA06Platz]
(    
...
(
    ...
    inner join KSAlias.dbo.TA06_FAD3 as b on a.TA06_FirmaNR  =@FirmaNr and b.TA06_FirmaNr =a.TA06_FirmaNr and b.TA06_BelegNr = a.TA06_BelegNr   and  a.TA06_Belegnr = @Belegnr 
    inner join KSAlias.dbo.ta05_fak1 on ta05_firmanr = a.ta06_firmanr and ta05_fa_nr = a.ta06_fa_nr
    inner join KSAlias.dbo.t905_ArbMasch on t905_firmanr = a.ta06_firmanr and T905_Nr = @Platz
    ...
    inner join KSAlias.dbo.ta20_artikel on ta20_firmanr = a.ta06_firmanr and ta20_nr = ta05_artikelnr 
