...
/****** Object:  StoredProcedure [dbo].[kspr_TA51UpdateFAEndWBFB1]    Script Date: 06.04.2022 11:08:00 ******/
SET ANSI_NULLS ON
GO
...
-- ==========================================================================================
CREATE OR ALTER PROCEDURE [dbo].[kspr_TA51UpdateFAEndWBFB1] 
     @FirmaNr varchar(2)
    , @EndeTS datetime
    , @PersNr bigint
    , @notPlatz varchar(20)
...
BEGIN
    ...
    insert into KSAlias.dbo.TA50_faerfassung (TA50_Firmanr,TA50_datumts,TA50_Belegnr,TA50_Ruecknr,TA50_PersNr,TA50_TAGID,TA50_Zusart,TA50_MengeIstGut,TA50_MengeIstAus,TA50_Satzart,TA50_Auf_Stat,Ta50_StatusRef,
                ...
                Select TA51_FirmaNr, @EndeTS ,TA51_Belegnr,'',@PERSNR,@TagId,'',0,0,'A','21',0,
                        ...
                        where  TA51_FirmaNr = @FirmaNr  
                            ...
                            and (TA21_Typ = '1' or TA21_StartAgain = '1')
    ...
    -- TA51 Ende setzen                
    update KSAlias.dbo.TA51_FAB1 set TA51_Auf_Stat = '21'
        ,TA51_EndeTS = @EndeTS
         ,TA51_Status = 'UE'
         ,TA51_Gen_Stat    = 0
         ,TA51_Aenderung = @TS
