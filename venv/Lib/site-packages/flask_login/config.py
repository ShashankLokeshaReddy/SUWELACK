...
LOGIN_MESSAGE = "Bitte melden Sie sich an, um auf diese Seite zuzugreifen."
...
REFRESH_MESSAGE = "Bitte authentifizieren Sie sich erneut, um auf diese Seite zuzugreifen."
